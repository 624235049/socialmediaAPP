...
import 'package:socialMediaApp/feature/auth/data/remote/data_sources_auth/firebase_remote_data_sources_auth.dart';
import 'package:socialMediaApp/feature/auth/data/remote/data_sources_auth/firebase_remote_datasources_auth_Impl.dart';
import 'package:socialMediaApp/feature/auth/data/repositories/firebase_repository_impl.dart';
import 'package:socialMediaApp/feature/auth/domain/repositories/firebase_repository.dart';
...
import 'package:socialMediaApp/feature/home/data/remote_data_source/firebase_remote_data_source_home.dart';
import 'package:socialMediaApp/feature/home/data/remote_data_source/firebase_remote_data_source_impl_home.dart';
import 'package:socialMediaApp/feature/home/data/repositories/firebase_repository_home_impl.dart';
import 'package:socialMediaApp/feature/home/domain/repositories/firebase_repository_home.dart';
import 'package:socialMediaApp/feature/home/domain/usecases/create_post_usecase.dart';
import 'package:socialMediaApp/feature/home/domain/usecases/get_all_posts.dart';
...
import 'package:socialMediaApp/feature/regis/data/remote_data_source/firebase_remote_data_sourcce_impl.dart';
import 'package:socialMediaApp/feature/regis/data/remote_data_source/firebase_remote_data_source.dart';
import 'package:socialMediaApp/feature/regis/data/repositories/firebase_repository_impl.dart';
...
Future<void> init() async {
  ...
  //Repositories
  sl.registerLazySingleton<FirebaseRepositoryHome>(
      () => FirebaseRepositoryHomeImpl(remoteDataSourceHome: sl.call()));
  ...
  //Remote DataSource
  sl.registerLazySingleton<FirebaseRemoteDataSourceHome>(() =>
      FirebaseRemoteDataSourceImplHome(firestore: sl.call(), auth: sl.call()));
